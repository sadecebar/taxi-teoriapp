...
},
{
  ...
  "options": [
    ...
    "Jag kör försiktigt till närmaste bensinstation",
    "Jag kör bilen till närmaste verkstad"
  ],
  "correct": 1,
...
},
{
  ...
  "options": [
    ...
    "Se till att hon lägger sig ned med benen högt och lägga en filt om henne",
    "Be henne att sätta sig och ge henne något varmt att dricka"
  ],
  "correct": 1,
  "image": null,
  "explanation": "Blek och kallsvettig person kan vara i chock och bör ligga ner, ha benen högt och hållas varm."
},
{
  "id": 410,
  "delprov": 2,
  ...
  "options": [
    ...
    "Jag låter motorn gå på tomgång i minst en minut innan jag börjar köra",
    "Jag låter motorn gå med förhöjt varvtal minst en minut innan jag börjar köra"
  ],
  "correct": 0,
  "image": null,
  "explanation": "Det bästa är att köra iväg direkt och försiktigt i stället för att låta bilen stå på tomgång."
},
{
  "id": 411,
  "delprov": 2,
