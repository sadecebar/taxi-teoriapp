...
},
{
  id: 152,
  delprov: 2,
  question: "Vilken högsta tillåtna hastighet gäller när du passerat detta vägmärke om inget annat anges?",
...
},
{
  id: 154,
  delprov: 2,
  question: "Tåget har just passerat. Får du passera järnvägskorsningen i den här situationen?",
  options: [
    "Ja, eftersom bommarna är uppe",
    "Ja, om sikten i korsningen är god",
    "Nej"
  ],
  correct: 2,
...
},
{
  id: 161,
  delprov: 2,
  question: "Du ska fortsätta köra rakt fram. Vilken av följande situationer har du väjningsplikt mot bilen från höger?",
  options: [
    "I situation A",
    "I situation B",
    "I situation C",
...
},
{
  id: 162,
  delprov: 2,
  question: "Du ska fortsätta rakt fram. I vilken situation ska du lämna företräde till bilen från höger?",
  options: [
    "I situation A",
    "I situation B",
    "I situation C",
...
},
{
  id: 163,
  delprov: 2,
  question: "Du har slutat ditt körpass den 4 oktober kl. 04.00. När kan du tidigast börja nästa körpass enligt tidboksbladet?",
...
},
{
  id: 166,
  delprov: 2,
  question: "Du kör taxi en måndag kl. 8.00. Efter vilket eller vilka vägmärken får du stanna för att vänta på en passagerare som dröjer?",
  options: [
...
},
{
  id: 170,
  delprov: 2,
  question: "Du är anställd som förare i ett taxiföretag. Får du köra en skolskjuts med en buss som har sittplats för 10 passagerare?",
  options: [
    "Ja, alltid",
...
},
{
  id: 171,
  delprov: 2,
  question: "Du ska parkera din taxi fredagen den 12:e så att den kan stå kvar så länge som möjligt. På vilken sida av gatan ska du enligt vägmärket parkera och hur länge får taxin stå kvar innan du måste flytta den?",
  options: [
...
},
{
  id: 172,
  delprov: 2,
  question: "Polisen begär att få se dina körpassrapporter vid en poliskontroll. För vilket eller vilka körpass är du skyldig att visa upp kopior av körpassrapporter?",
  options: [
...
},
{
  id: 174,
  delprov: 2,
  question: "Du kör taxi en helgfri tisdag och klockan är 20.00. Får du stanna efter vägmärkena för att släppa av en kund?",
  options: [
...
},
{
  id: 185,
  delprov: 2,
  question: "Vilka fordon får du köra i yrkesmässig taxitrafik, förutom personbilar?",
  options: [
...
},
{
  id: 187,
  delprov: 2,
  question: "Du har tappat bort din taxiförarlegitimation och ansökt om en ny. Får du i väntan på provisorisk eller ny legitimation köra taxi?",
  options: [
    "Ja, men högst ett dygn",
    "Ja, men högst en vecka",
    "Ja, men högst en månad",
    "Nej"
  ],
  correct: 3,
  image: null,
...
},
{
  id: 188,
  delprov: 2,
  question: "Du ska skjutsa en mamma med ett tvåårigt barn. Det finns ingen särskild skyddsutrustning till barnet. Får barnet lov att åka med i din taxi?",
  options: [
    "Ja, men endast en kort sträcka och barnet måste då sitta i baksätet",
    "Nej, aldrig",
    "Ja, men endast en kort sträcka och barnet måste då sitta i framsätet i mammans knä"
  ],
  correct: 0,
  image: null,
...
},
{
  id: 189,
  delprov: 2,
  question: "Vilken funktion har de blinkande gula lamporna?",
  options: [
    "De visar att högerregeln gäller i korsningen",
    "De visar att spårvagnsförare har väjningsplikt i korsningen",
...
},
{
  id: 191,
  delprov: 2,
  question: "Du behöver vända bilen i en korsning och måste backa. Vad gäller?",
  options: [
    "Jag får inte hindra någon annan trafikant",
    "Jag måste lämna företräde enbart för oskyddade trafikanter",
    "Andra trafikanter måste visa hänsyn och väja för mig",
    "Jag måste lämna företräde enbart för andra fordonsförare"
  ],
  correct: 0,
  image: null,
...
},
{
  id: 194,
  delprov: 2,
  question: "Du ska svänga till vänster. I vilka situationer på bilderna har du väjningsplikt mot mötande fordon?",
  options: [
    "Enbart i A och B",
    "Enbart i C och D",
    "Enbart i A, B och C",
...
},
{
  id: 195,
  delprov: 2,
  question: "Du närmar dig en korsning där högerregeln gäller. Vilka fordon som kommer från höger ska du lämna företräde?",
  options: [
    "Alla fordon",
    "Enbart motorfordon",
    "Enbart fordon med fler än två hjul",
    "Enbart motordrivna fordon"
  ],
  correct: 0,
  image: null,
...
},
{
  id: 196,
  delprov: 2,
  question: "Får du stanna med din taxi på en markerad busshållplats, om du inte hindrar linjetrafiken?",
  options: [
    "Ja, för att svara i mobiltelefonen",
    "Ja, för att lasta eller lossa gods, eller för att släppa av eller ta upp passagerare",
...
},
{
  id: 197,
  delprov: 2,
  question: "Det är den 9 mars enligt bild A. Gatan på bild B är inte huvudled och saknar anvisningar om parkering. Får du parkera där?",
  options: [
    "Ja, men högst 7 dygn",
    "Ja, under obegränsad tid",
    "Ja, men högst 24 timmar",
    "Nej"
  ],
  correct: 2,
...
},
{
  id: 201,
  delprov: 2,
  question: "Du parkerar din bil klockan 15.00 en tisdag och följande dag är helgfri. När måste du senast hämta bilen?",
  options: [
    "På tisdag kl. 17.00",
    "På onsdag kl. 08.00",
    "På onsdag kl. 10.00",
  ...
  correct: 2,
  image: "https://teori-taxi.com/images/Lagstiftning/203.png",
  explanation: "Märket visar att parkering är tillåten, men högst 2 timmar under tiden 08.00–14.00 på vardagar utom vardag före sön- och helgdag. Eftersom du parkerar först klockan 15.00 på tisdagen börjar tidsbegränsningen inte gälla förrän onsdag klockan 08.00. Två timmar senare, alltså klockan 10.00, måste bilen senast flyttas."
},
{
  id: 202,
  delprov: 2,
  question: "Du börjar ditt körpass klockan 07.00 efter avslutad dygnsvila. Du gör uppehåll i arbetet mellan klockan 09.00 och 13.00. När måste du senast sluta köra taxi enligt vilotidsreglerna?",
  options: ["kl. 21.00", "kl. 22.00", "kl. 23.00", "kl. 24.00"],
  correct: 2,
  image: null,
  explanation: "I varje rullande 24-timmarsperiod före en tidpunkt då du kör taxi måste det finnas minst 11 timmars dygnsvila. Dygnsvilan får delas upp i två perioder, men då måste en av dem vara minst 8 timmar. Vid klockan 23.00 innehåller 24-timmarsfönstret fortfarande 8 timmars sammanhängande vila före 07.00 samt uppehållet 09.00–13.00. Vid klockan 24.00 återstår bara 7 timmar av den längre viloperioden inom fönstret, och då uppfylls inte kravet längre. Därför är kl. 23.00 senaste tillåtna sluttid."
},
{
  id: 203,
  delprov: 2,
  question: "Hur ska passagerare kunna få reda på vad en taxiresa kommer att kosta, om företaget inte har fasta priser?",
  options: [
    "Föraren ska kunna tala om det exakta priset för resan före färd",
    "Föraren ska kunna ta fram en prislista med jämförpris vid förfrågan",
    "Jämförpris ska finnas skriftligt väl synligt både inne i bilen och utanför"
  ],
  correct: 2,
  image: null,
  explanation: "Om taxiföretaget inte har fasta priser ska fordonet ha tydlig prisinformation med jämförpris. Den ska vara skriftlig och väl synlig både inne i fordonet och på utsidan. Syftet är att kunden redan före resan ska kunna jämföra prisnivån mellan olika taxifordon."
},
{
  id: 204,
  delprov: 2,
  question: "Vilken av följande kan straffas om ett barn under 15 år inte använder bilbälte eller särskild skyddsanordning vid en skolskjutsning?",
  options: [
    "Föraren, och i vissa fall även ombordpersonal, ledsagare eller ledare för gruppen",
    "Enbart barnet",
    "Enbart tillståndshavaren",
    "Barnet och tillståndshavaren"
  ],
  correct: 0,
  image: null,
  explanation: "Reglerna lägger ansvaret på vuxna funktioner i transporten, inte på barnet. Föraren ska se till att barn under 15 år använder bilbälte eller särskild skyddsanordning. Även annan ombordpersonal, ledsagare eller ledare för en grupp kan omfattas av ansvar enligt samma regel. Tillståndshavaren är däremot inte den som pekas ut i just denna bestämmelse."
},
{
  id: 205,
  delprov: 2,
  question: "Du ska svänga höger i korsningen. Vad gäller?",
  options: [
    "Jag stannar i höjd med stoppmärket",
    "Jag ska stanna omedelbart innan jag kör in på den korsande vägen",
    "Eftersom stopplinje saknas behöver jag inte stanna"
  ],
  correct: 1,
  image: "https://teori-taxi.com/images/Lagstiftning/207.png",
  explanation: "Vid stopplikt måste du alltid stanna. Om det finns en stopplinje ska du stanna där. Om stopplinje saknas ska du stanna precis innan du kör in på den korsande vägen, där du har bäst möjlighet att bedöma trafiken. Därför är alternativ 2 rätt."
},
{
  id: 206,
  delprov: 2,
  question: "Vad är en bils tjänstevikt?",
  options: [
    "Den sammanlagda vikten av bilens last och föraren",
    "Bilens vikt inklusive vätskor, reservhjul och verktyg som hör till fordonet, samt föraren",
    "Den vikt som bilen för tillfället har, inklusive last och förare"
  ],
  correct: 1,
  image: null,
  explanation: "Tjänstevikt är bilens vikt i normalt, körklart skick. I den räknas bland annat bränsle, andra vätskor, reservhjul, verktyg och föraren in. Last ingår däremot inte. Det är därför viktigt att skilja tjänstevikt från bruttovikt, som är fordonets verkliga vikt vid ett visst tillfälle."
},
{
  id: 207,
  delprov: 2,
  question: "Du ska fortsätta mot CENTRUM i cirkulationsplatsen. Är du skyldig att ge tecken med körriktningsvisaren?",
  options: [
    "Nej, eftersom jag fortsätter rakt fram i cirkulationsplatsen",
    "Ja, genom att blinka åt vänster när jag kör in i cirkulationsplatsen och blinka åt höger strax innan jag lämnar den",
    "Ja, genom att blinka åt höger när jag kör in i cirkulationsplatsen och fortsätta med det tills jag har lämnat den",
    "Ja, genom att blinka åt höger strax innan jag lämnar cirkulationsplatsen"
  ],
  correct: 3,
  image: "https://teori-taxi.com/images/Lagstiftning/209-600x457.png",
  explanation: "När du lämnar en cirkulationsplats ska du ge tecken åt höger i god tid. Det är det som är det viktiga och obligatoriska här. Att färdas rakt fram genom en cirkulationsplats ändrar inte den skyldigheten. Tänk alltså: blinka när du ska ut, så att andra trafikanter tydligt förstår din avsikt."
},
{
  id: 208,
  delprov: 2,
  question: "Märket C34, stopp för angivet ändamål, är uppsatt före en trafiksignal. Signalen visar grönt och du ska fortsätta rakt fram. Hur ska du göra?",
  options: [
    "Fortsätta köra eftersom märket inte innebär stopplikt i det här fallet",
    "Stanna vid stopplinjen och därefter fortsätta köra",
    "Stanna omedelbart före den korsande vägen och lämna korsande trafik företräde"
  ],
  correct: 0,
  image: null,
  explanation: "Märket C34 betyder inte stopplikt. Om märket sitter före en trafiksignal innebär det att du ska stanna vid röd signal, inte att du alltid måste stanna. Visar signalen grönt får du fortsätta köra. Ett bra sätt att tänka är att skilja mellan stopplikt och stopp för angivet ändamål, eftersom de fungerar olika trots att båda handlar om att stanna i vissa lägen."
},
{
  id: 209,
  delprov: 2,
  question: "Du kör taxi och din kund har bråttom. Du missar avfarten som du skulle av vid. Får du vända på motorvägen med hjälp av överfarten i mitten?",
  options: [
    "Ja, eftersom den inte är spärrad",
    "Ja, eftersom den är till för taxitrafik och utryckningsfordon",
    "Ja, om jag kan göra det utan att hindra eller störa övrig trafik",
    "Ja, eftersom det är en brådskande transport",
    "Nej"
  ],
  correct: 4,
  image: "https://teori-taxi.com/images/Lagstiftning/211-600x433.png",
  explanation: "Nej. På motorväg får du varken vända, backa eller köra över skiljeremsan eller en tvärgående förbindelse mellan körbanorna. En öppning i mitträcket är alltså inte till för att du som taxiförare ska kunna rätta till en missad avfart. Om du kör fel måste du fortsätta till nästa lagliga möjlighet att lämna eller vända."
},
{
  id: 210,
  delprov: 2,
  question: "Vad gäller om en trafiksignal visar grön pil för högersväng?",
  options: [
    "Jag får köra i pilens riktning även om en annan signalbild visas samtidigt",
    "Jag måste vänta tills den vanliga gröna signalen tänds",
    "Jag måste först stanna bara för att högersvängen är markerad med pil"
  ],
  correct: 0,
  image: null,
  explanation: "En grön pil gäller den färdriktning som pilen visar. Du får alltså köra i pilens riktning även om en annan signalbild visas samtidigt. Tänk ändå på att anpassa körningen till andra trafikanter, till exempel gående och cyklister, och att kontrollera att svängen kan genomföras säkert."
},
{
  id: 211,
  delprov: 2,
  question: "En taxitillståndshavare anlitar en förare som saknar taxiförarlegitimation. Vilket är det strängaste straffet enligt taxitrafiklagen?",
  options: [
    "Vite",
    "Böter",
  ...
  correct: 2,
  image: null,
  explanation: "En tillståndshavare som anlitar en förare utan taxiförarlegitimation kan dömas till böter eller fängelse i högst sex månader. Frågan gäller alltså straffansvaret enligt taxitrafiklagen, inte administrativa åtgärder som kan påverka själva tillståndet."
},
{
  id: 212,
  delprov: 2,
  question: "Du närmar dig korsningen på bilden. Hur ska du tolka vägmärket och köra?",
  options: [
    "Jag kan hålla samma hastighet eftersom jag har företräde",
    "Jag ska lämna företräde åt fordon från höger enligt högerregeln",
    "Jag ska sänka hastigheten och vara beredd på en korsning där anslutande trafik har väjningsplikt eller stopplikt"
  ],
  correct: 2,
  image: "https://www.teori-taxi.com/images/Lagstiftning/24.png",
  explanation: "Varningsmärket betyder att du närmar dig en korsning där trafikanter på den anslutande vägen har väjningsplikt eller stopplikt. Du har alltså inte högerregeln mot dig här, men du ska ändå vara extra uppmärksam och anpassa hastigheten eftersom det är en korsning med möjlig konflikt."
},
{
  id: 213,
  delprov: 2,
  question: "Får du reducera det slutliga priset i taxametern när den står inställd på STOPPAD eller KASSA?",
  options: [
    "Ja, vid köruppdrag som planeras av ett externt samplaneringssystem",
    "Ja, om priset i taxametern är högre vid resans slut än vad kunden har blivit informerad om före färd",
    "Nej, aldrig"
  ],
  correct: 2,
  image: null,
  explanation: "Nej. Ett belopp som redan har registrerats i taxameterutrustningen får inte reduceras. Det är viktigt att skilja på att registrera ett pris på rätt sätt och att i efterhand försöka sänka ett redan registrerat belopp."
},
{
  id: 214,
  delprov: 2,
  question: "Du behöver stanna din taxi för att släppa av en kund vid tegelhuset på höger sida. Vad är rätt i den här situationen?",
  options: [
    "Ja, jag får stanna vid körbanans högra kant om jag inte hindrar eller skapar fara",
    "Ja, jag får stanna på gång- och cykelbanan intill huset",
    "Nej, jag får inte stanna här alls"
  ],
  correct: 0,
  image: "https://teori-taxi.com/images/Lagstiftning/216-600x407.png",
  explanation: "Här syns ingen skylt som förbjuder stannande på körbanan. Den vita linjen vid sidan är en kantlinje, inte en heldragen linje mellan körfält. Du får därför stanna vid körbanans högra kant för att släppa av en kund, så länge du inte hindrar trafiken eller skapar fara. Däremot får du inte stanna på gång- eller cykelbanan."
},
{
  id: 215,
  delprov: 2,
  question: "Du ska fortsätta rakt fram och en mopedist kommer från höger i korsningen. Hur ska du göra?",
  options: [
    "Fortsätta köra eftersom ni har ögonkontakt",
    "Sänka hastigheten och lämna mopedisten företräde",
    "Fortsätta köra eftersom högerregeln inte gäller mot mopedister"
  ],
  correct: 1,
  image: "https://teori-taxi.com/images/Lagstiftning/217-600x424.png",
  explanation: "Om högerregeln gäller ska du lämna företräde åt fordon som kommer från höger. En moped är också ett fordon i trafiken. Ögonkontakt ändrar inte väjningsreglerna. Tänk därför: sänk hastigheten i god tid och kör bara vidare när det kan ske utan fara eller hinder."
},
]