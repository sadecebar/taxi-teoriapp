export const LAGSTIFTNING_2 = [
  {
    id: 51,
    delprov: 2,
    question: "Hur ska du uppträda i den här situationen?",
    options: [
  ...
  },
  {
    id: 60,
    delprov: 2,
    question: "Dygnsvilan för en förare i taxitrafik får delas upp. Vilket alternativ visar en riktig uppdelning av dygnsvilan?",
    options: [
      "3 tim + 8 tim",
      "5 tim + 6 tim",
      "1 tim + 4 tim + 6 tim",
...
},
{
  id: 64,
  delprov: 2,
  question: "Du har ett köruppdrag där fast pris ska gälla. När ska du senast registrera det fasta priset i taxametern? (Priset är inte bestämt av något externt samplaneringssystem)",
  options: [
...
},
{
  ...
  options: [
    ...
    "Jag måste hämta tidboken innan jag börjar körpasset, eftersom jag inte får börja på en ny tidbok förrän den tidigare är avslutad",
...
},
{
  id: 69,
  delprov: 2,
  question: "Du ska svänga till höger. Vad gäller?",
  options: [
...
},
{
  id: 70,
  delprov: 2,
  question: "Du avser att svänga in på vägen till vänster. Vad är det första du bör göra?",
  options: [
...
},
{
  id: 71,
  delprov: 2,
  question: "Taxiföraren har stannat för att släppa av en kund. Är det tillåtet?",
  options: [
    "Ja, i situation A",
    "Ja, i situation B",
...
},
{
  id: 73,
  delprov: 2,
  question: "Du ska hämta en passagerare. Får du stanna som taxin på bilden?",
  options: [
...
},
{
  id: 76,
  delprov: 2,
  question: "Vilka får parkera här?",
  options: [
...
},
{
  id: 79,
  delprov: 2,
  question: "En polisman begär att få se körpassrapporter från de senaste dygnen som ditt fordon använts i taxitrafik. För minst hur många dygn är du skyldig att visa upp kopior av körpassrapporterna?",
  options: [
...
},
{
  id: 81,
  delprov: 2,
  question: "Du ska svänga vänster i korsningen. Måste du ge tecken åt vänster med körriktningsvisaren?",
  options: [
...
},
{
  id: 85,
  delprov: 2,
  question: "Du parkerar din bil lördag kl. 20.00. När får du senast hämta den?",
  options: [
    "Söndag kl. 7.00",
    "Söndag kl. 24.00",
    "Måndag kl. 7.00",
...
},
{
  id: 87,
  delprov: 2,
  question: "Vad innebär polisens tecken?",
  options: [
...
},
{
  id: 89,
  delprov: 2,
  question: "Är någon av bilarna felparkerad?",
  options: [
    "Ja, båda bilarna",
...
},
{
  id: 97,
  delprov: 2,
  question: "Du ska fortsätta rakt fram. Har du väjningsplikt mot bilen i någon av korsningarna?",
  options: [
...
},
{
  id: 99,
  delprov: 2,
  question: "Du kör på en väg där det finns både vita och orangefärgade linjer på din del av körbanan. Vad innebär detta för dig?",
  options: [
...
},
{
  id: 100,
  delprov: 2,
  question: "Under en vecka kör du taxi torsdag, fredag och lördag. Vid varje tillfälle kör du från kl. 07.00 till kl. 17.00. För hur många kalenderdygn måste du göra anteckningar i tidboken denna vecka?",
  options: [
    "Tre",
    "Fyra",
    "Fem",
